...
import { getPizza } from '../../services/products'
...
export default function Products(props) {
  ...
  const currentProducts = pizza.slice(firstProductIndex, lastProductIndex);
  ...
  return (
    <div className='product-ctr'>
      ...
      <Pagination totalProducts={pizza.length} productsPerPage={productsPerPage} setCurrentPage={setCurrentPage} />
    </div>
  )
}
